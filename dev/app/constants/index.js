...
export const CLIENT_STATUS = {ONGOING:0, EATEN:1, DROPOUT:2, LOSER:3, WINNER:4, STUCK:5};

// export const INITIAL_STORE_STATE = 
//    {board: {clientStatus:CLIENT_STATUS.ONGOING, checkersState:[
...
//     ]}, turn: {clientTurn:false, diced:false, dicesResult:{dice1:0, dice2:0}, steps:[]}};

export const INITIAL_STORE_STATE = 
   {board: {clientStatus:CLIENT_STATUS.DROPOUT, checkersState:[
    {amount:0, isClient:true, pointId:0},

    {amount:0, isClient:true, pointId:1}, {amount:2, isClient:false, pointId:2}, 
    {amount:0, isClient:true, pointId:3}, {amount:0, isClient:true, pointId:4}, 
    {amount:0, isClient:true, pointId:5}, {amount:0, isClient:false, pointId:6},

    {amount:0, isClient:true, pointId:7}, {amount:0, isClient:false, pointId:8}, 
    {amount:0, isClient:true, pointId:9}, {amount:0, isClient:true, pointId:10}, 
    ...
    {amount:0, isClient:true, pointId:21}, {amount:0, isClient:true, pointId:22},
    {amount:2, isClient:true, pointId:23}, {amount:0, isClient:false, pointId:24},
