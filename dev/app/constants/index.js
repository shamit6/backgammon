...
//     ];
const CHECKERS_ORDER = [
    {amount:0, isClient:true, pointId:0},

    {amount:2, isClient:false, pointId:1}, {amount:0, isClient:true, pointId:2}, 
    {amount:0, isClient:false, pointId:3}, {amount:0, isClient:true, pointId:4}, 
    ...
    {amount:0, isClient:true, pointId:21}, {amount:0, isClient:true, pointId:22},
    {amount:0, isClient:true, pointId:23}, {amount:2, isClient:true, pointId:24},
...
export const getInitialSessionState =  () => ({isLoggedIn:false, status: PLAY_STATUS.NOT_PLAY});
