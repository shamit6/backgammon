...
class RegistrationForm extends Component {
  ...
  handleRegistration(e) {
    ...
    axios
      .post("/register", this.state.formData)
      .then((res) => {
  ...
  validateUserName(username) {
    axios
      .post("/register/validation/username", { username: username })
      .then((res) => {
        this.setState({
          usernameChecking: false,
          usernameFieldIcon: {
  ...
  render() {
    ...
    return (
      <Form
        ...
        success={this.state.actionSuccessed}
      >
        <Form.Group width={2}>
          <Form.Input
        ...
        <Message content="You can login now" header="Welcome" success />
      </Form>
    );
  }
}
